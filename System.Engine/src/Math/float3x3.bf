namespace System.Math
{
    ...
    public struct float3x3 : IEquatable<float3x3>
    {
        ...
        /// Creates a rotation matrix from a qfloat.
        /// </summary>
        public static explicit operator float3x3(Quaternion  q) => q.ToMat3;
        ...
        /// </summary>
        public Quaternion ToQuaternion => Quaternion.FromMat3(this);
        ...
        /// </summary>
        public static Vector3 operator*(float3x3 m, Vector3 v) => Vector3(((m.m00 * v.x + m.m10 * v.y) + m.m20 * v.z), ((m.m01 * v.x + m.m11 * v.y) + m.m21 * v.z), ((m.m02 * v.x + m.m12 * v.y) + m.m22 * v.z));
