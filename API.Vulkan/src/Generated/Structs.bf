...
namespace API.Vulkan
{
	...
	public struct VkExtent2D
	{
		...
		{
			strBuffer.AppendF("VkExtend2D({0}, {1})", this.width, this.height);
		}
	}
	...
	[CRepr]
	public struct VkInstanceCreateInfo : IFormattable
	{
		...
		public void ToString (String buffer, String format, IFormatProvider formatProvider)
		{
			buffer
				..Append(nameof(VkInstanceCreateInfo), "()\n{\n")
				..AppendF(" · {0} = {1},\n", nameof(pNext), pNext)
				..AppendF(" · {0} = {1},\n", nameof(flags), flags)
				..AppendF(" · {0} = {1},\n", nameof(pApplicationInfo), pApplicationInfo)
				..AppendF(" · {0} = {1},\n", nameof(enabledLayerCount), enabledLayerCount)
				..AppendF(" · {0} = {1},\n", nameof(ppEnabledLayerNames), ppEnabledLayerNames)
				..AppendF(" · {0} = {1},\n", nameof(enabledExtensionCount), enabledExtensionCount)
				..AppendF(" · {0} = {1},\n", nameof(ppEnabledExtensionNames), ppEnabledExtensionNames)
				..Append("}\n")
				;
		}
	}
	...
	public struct VkBufferCreateInfo
	{
		...
		/// Bitmask of VkBufferCreateFlagBits specifying additional parameters of the buffer.
		public VkBufferCreateFlags flags;

		/// Size in bytes of the buffer to be created.
		public uint64 size;

		/// Bitmask of VkBufferUsageFlagBits specifying allowed usages of the buffer.
		public VkBufferUsageFlags usage;

		/// VkSharingMode value specifying the sharing mode of the buffer
		...
		/// that will access this buffer. It is ignored if sharingMode is
	...
	public struct VkDescriptorPoolSize
	{
		...
		public this (VkDescriptorType type, uint32 count)
		{
			this.type = type;
	...
	public struct VkSwapchainCreateInfoKHR
	{
		...
		public void ToString (String buffer)
		{
			buffer
				..AppendF("{0}()\n{\n", nameof(Self))
				..AppendF("void* pNext = {0}\n", pNext)
				..AppendF("VkSwapchainCreateFlagsKHR flags = {0}\n", flags)
				..AppendF("VkSurfaceKHR surface = {0}\n", surface)
				..AppendF("uint32 minImageCount = {0}\n", minImageCount)
				..AppendF("VkFormat imageFormat = {0}\n", imageFormat)
				..AppendF("VkColorSpaceKHR imageColorSpace = {0}\n", imageColorSpace)
				..AppendF("VkExtent2D imageExtent = {0}\n", imageExtent)
				..AppendF("uint32 imageArrayLayers = {0}\n", imageArrayLayers)
				..AppendF("VkImageUsageFlags imageUsage = {0}\n", imageUsage)
				..AppendF("VkSharingMode imageSharingMode = {0}\n", imageSharingMode)
				..AppendF("uint32 queueFamilyIndexCount = {0}\n", queueFamilyIndexCount)
				..AppendF("uint32* pQueueFamilyIndices = {0}\n", pQueueFamilyIndices)
				..AppendF("VkSurfaceTransformFlagsKHR preTransform = {0}\n", preTransform)
				..AppendF("VkCompositeAlphaFlagsKHR compositeAlpha = {0}\n", compositeAlpha)
				..AppendF("VkPresentModeKHR presentMode = {0}\n", presentMode)
				..AppendF("VkBool32 clipped = {0}\n", clipped)
				..AppendF("VkSwapchainKHR oldSwapchain = {0}\n", oldSwapchain)
				..Append("\n}\n");
