namespace Engine
{
    ...
    public struct Vector2 : IHashable
    {
        ...
        /// </summary>
        public static explicit operator int2(Vector2 v) =>  int2((int)v.x, (int)v.y);
        
        /// <summary>
        /// Explicitly converts this to a int3. (Higher components are zeroed)
        /// </summary>
        public static explicit operator int3(Vector2 v) =>  int3((int)v.x, (int)v.y, 0);
        ...
        /// </summary>
        readonly public static Vector2 Ones  =  Vector2(1f, 1f);
        ...
        /// </summary>
        public static int2 Sign(Vector2 v) => int2(System.Math.Sign(v.x), System.Math.Sign(v.y));
