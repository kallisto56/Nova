namespace Engine
{
    ...
    public struct int3 : IHashable
    {
		...
		{
			this.values = .(int(v.x), int(v.y), int(v.z));
		}
        ...
        /// </summary>
        public static implicit operator Vector3(int3 v) =>  Vector3((float)v.x, (float)v.y, (float)v.z);
        ...
        /// </summary>
        public static explicit operator Vector2(int3 v) =>  Vector2((float)v.x, (float)v.y);
        
        /// <summary>
        /// Explicitly converts this to a float4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator Vector4(int3 v) =>  Vector4((float)v.x, (float)v.y, (float)v.z, 0f);
