namespace Engine
{
    ...
    public struct uint2 : IHashable
    {
        ...
        /// </summary>
        public static implicit operator Vector2(uint2 v) =>  Vector2((float)v.x, (float)v.y);
        ...
        /// </summary>
        public static explicit operator Vector3(uint2 v) =>  Vector3((float)v.x, (float)v.y, 0f);
        
        /// <summary>
        /// Explicitly converts this to a float4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator Vector4(uint2 v) =>  Vector4((float)v.x, (float)v.y, 0f, 0f);
